...
class FrmPengembalian:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='KODE PENGEMBALIAN:').grid(row=0, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='TGL PENGEMBALIAN:').grid(row=1, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='KODE BUKU:').grid(row=2, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='KODE ANGGOTA:').grid(row=3, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='KODE PETUGAS:').grid(row=4, column=0,
            sticky=W, padx=5, pady=5)
        # Textbox
        self.txtKode_pengembalian = Entry(mainFrame, width=50) 
        ...
        # Textbox
        self.txtTgl_pengembalian = Entry(mainFrame, width=50) 
        ...
        self.tree.heading('kode_pengembalian', text='KODE')
        self.tree.column('kode_pengembalian', width="190")
        self.tree.heading('tgl_pengembalian', text='TGL PENGEMBALIAN')
        self.tree.column('tgl_pengembalian', width="190")
        ...
        self.tree.column('kode_petugas', width="90")
        # set tree position
